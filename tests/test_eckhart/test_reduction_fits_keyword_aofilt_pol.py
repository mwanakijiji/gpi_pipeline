...
recipename = 'gpi2_fits_keyword_aofilt_pol.xml'
nfiles_expected = 1
...
def test_pol(pipeline, test_dir):
    ...
    assert stem+"/test_S20181121S0114_keyword_aofilt_podc.fits" in outfiles, "Output files didn't contain one of the _podc cubes."
    
    # Are the contents of that file what we expected?
    cube = gpipy.read( stem+"/test_S20181121S0114_keyword_aofilt_podc.fits")
